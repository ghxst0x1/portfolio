export default function Contact() {
  return (
    <div className="px-5 md:px-10 py-16 max-w-[800px] mx-auto w-full">
      <div className="flex flex-col gap-12">
        <div>
          ...
          <p className="text-[0.95rem] text-white-dim leading-[1.8] font-light max-w-[480px]">
        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-20">
          ...
          <div className="flex flex-col w-full md:w-1/2">
            <div className="p-4 bg-background border border-border-color rounded-[4px]">
              <div className="font-mono text-[0.68rem] tracking-[0.1em] uppercase text-white-muted mb-3 border-b border-border-color pb-2">PGP Public Key</div>
